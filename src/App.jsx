...
const currencyOptions = [
  { value: "USD", label: "USD", flag: "https://flagcdn.com/w40/us.png" },
  { value: "INR", label: "INR", flag: "https://flagcdn.com/w40/in.png" },
  { value: "GBP", label: "GBP", flag: "https://flagcdn.com/w40/gb.png" },
  { value: "EUR", label: "EUR", flag: "https://flagcdn.com/w40/eu.png" },
  { value: "JPY", label: "JPY", flag: "https://flagcdn.com/w40/jp.png" },
  { value: "CAD", label: "CAD", flag: "https://flagcdn.com/w40/ca.png" },
  { value: "AUD", label: "AUD", flag: "https://flagcdn.com/w40/au.png" },
];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-black to-slate-800 p-4">
      ...
      <div className="w-full max-w-lg bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
        ...
        <button
          ...
          className="w-full bg-blue-500 hover:bg-blue-600 disabled:opacity-50 text-white p-4 rounded-xl font-semibold"
        >
